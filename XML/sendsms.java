	public static void main (String [] args) throws UnsupportedEncodingException, IOException {
		...
		String password = "pass";  //string Password
		String alphaName = "SMS CLUB";    //string, sender id (alpha-name) (as long as your alpha-name is not spelled out, it is necessary to use it)
		String abonent = "380675126767;380997777662";
